...
- (void)viewDidLoad
{
  ...
  [super viewDidLoad] ;
	...
	progressView = [[WPProgressView alloc] initWithFrame: CGRectMake(20.0f, 140.0f, self.view.bounds.size.width-40.0f, 14.0f)] ;
	[progressView setOuterColor: [UIColor grayColor]] ;
  [progressView setInnerColors: @[[UIColor lightGrayColor], [UIColor whiteColor]]] ;
...
- (void)updateProgress
{
	...
	[progressView setProgress: testProgress+0.01 forIndicator:1] ;
